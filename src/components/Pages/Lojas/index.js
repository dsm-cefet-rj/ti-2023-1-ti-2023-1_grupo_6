...
const Lojas = () => {
    ...
    const lojas = [
        {nome: "Gato pra Cachorro Pet Shop", animais_atendidos: "Gato • Cachorro • Coelho • Hamster", contato: "(21) 9 999-9999",  avaliacao: "5,0 ⭐⭐⭐⭐⭐", endereco: "Avenida Gato Fofo, 164", image:<img src={petshop1} alt="pet1" width="350" height="300px"/>},
